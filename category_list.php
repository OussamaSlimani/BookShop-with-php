...
// Assuming you have a specific category ID
...
$booksQuery = "SELECT b.*, c.name AS category FROM books b
               LEFT JOIN categories c ON b.category_id = c.category_id";

if ($category_id) {
  $booksQuery .= " WHERE b.category_id = :category_id";
}
...
if ($category_id) {
  $booksStmt->bindParam(':category_id', $category_id, PDO::PARAM_INT);
}
...
<body>
  ...
  <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center">
      ...
      <?php else : ?>
        <p class="text-white">Category not found.</p>
      <?php endif; ?>
    </div>
  </div>
  <!-- Page Header End -->
